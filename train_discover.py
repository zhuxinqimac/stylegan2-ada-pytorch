...
# --- Last Modified: Fri 03 Sep 2021 02:51:10 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
...
#----------------------------------------------------------------------------
KEY_BRIEF_NAMES = {'z': 'nv_dim', 'at': 'att_type', 'nt': 'nav_type', 'amf': 'att_middle_feat', 'nmf': 'nav_middle_feat', 'nod': 'norm_on_depth',
...
KEY_DTYPES = {'nv_dim': int, 'att_type': str, 'nav_type': str, 'att_middle_feat': int, 'nav_middle_feat': int, 'norm_on_depth': bool,
...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'basic':      dict(ref_gpus=2, kimg=25000,  mb=32, mbstd=4, fmaps=0.125, lrate=0.002, gamma=10, ema=10,  ramp=0.05,
                           nv_dim=20, att_type='fixed', nav_type='fixed', att_middle_feat=128, nav_middle_feat=128, norm_on_depth=False,
    ...
    args.M_kwargs.att_kwargs = dnnlib.EasyDict(middle_feat=spec.att_middle_feat)
    args.M_kwargs.nav_kwargs = dnnlib.EasyDict(middle_feat=spec.nav_middle_feat)
