...
def compute_feature_stats_for_dataset(opts, detector_url, detector_kwargs, rel_lo=0, rel_hi=1, batch_size=32, data_loader_kwargs=None, max_items=None, **stats_kwargs):
