...
# --- Last Modified: Mon 23 Aug 2021 13:52:26 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', 'celeba-basic', 'celeba-efficient', 'celeba-experiment']))
