...
# --- Last Modified: Mon 23 Aug 2021 16:11:49 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'celeba-experiment-hpc': dict(ref_gpus=1, kimg=25000,  mb=8, mbstd=2, fmaps=0.125, lrate=0.002, gamma=10, ema=10,  ramp=0.05, n_samples_per=7,
