...
# --- Last Modified: Sat 28 Aug 2021 02:44:20 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'celeba-experiment-I': dict(ref_gpus=2, kimg=25000,  mb=32, mbstd=4, fmaps=0.125, lrate=0.002, gamma=10, ema=10,  ramp=0.05, n_samples_per=7,
                             ...
                             post_exp_conv_feat_base=8, commute_lamb=0, hessian_lamb=1, I_lambda=0, I_g_lambda=10),
        ...
        'celeba-hessian-z32-I-hpc': dict(ref_gpus=2, kimg=25000,  mb=32, mbstd=4, fmaps=0.125, lrate=0.002, gamma=10, ema=10,  ramp=0.05, n_samples_per=7,
                             ...
                             post_exp_conv_feat_base=4, commute_lamb=0, hessian_lamb=10, I_lambda=0, I_g_lambda=0.1),
