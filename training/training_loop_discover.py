...
# --- Last Modified: Sat 08 May 2021 22:23:31 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
    ...
    for i in range(M.z_dim):
        ...
        for j in range(n_samples_per // 2):
            for k in range(5): # Record every 10 steps
                ...
                print('M.use_local_layer_heat.dtype:', M.use_local_layer_heat.dtype)
                print('M.use_global_layer_heat.dtype:', M.use_global_layer_heat.dtype)
