...
# --- Last Modified: Mon 06 Sep 2021 20:53:54 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
Lie StyleGAN
...
from training.networks import SynthesisNetwork, MappingNetwork
...
class Generator(torch.nn.Module):
    ...
    def forward(self, z, c, truncation_psi=1, truncation_cutoff=None, return_feats=False, **synthesis_kwargs):
